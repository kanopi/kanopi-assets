...
// yours to tune. Paths assume the Pantheon web/ docroot; update to your custom
// theme(s)/plugin(s).
...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->paths([
        __DIR__ . '/web/wp-content/themes/mytheme',
    ]);
    ...
    $rectorConfig->skip([
        ...
        __DIR__ . '/web/wp-content/uploads/*',
        __DIR__ . '/web/wp-content/cache/*',
        __DIR__ . '/web/wp-admin/*',
        __DIR__ . '/web/wp-includes/*',
    ]);
