...
// rector.php — Drupal automated refactors. Seeded once (overwrite:false) — yours
// to tune. Modeled on kanopi/drupal-starter. Process paths come from the composer
// `rector-*` scripts; the Drupal root is resolved dynamically, so this is
// docroot-agnostic.
